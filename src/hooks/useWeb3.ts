...
const USDC_CONTRACT_ADDRESS = import.meta.env.VITE_USDC_CONTRACT_ADDRESS as string;
const BASE_CHAIN_ID = parseInt(import.meta.env.VITE_BASE_CHAIN_ID as string);
const BASE_RPC_URL = import.meta.env.VITE_BASE_RPC_URL as string;
